...
class Bill_App:
    def __init__(self,root):
        ...
        c1=Label(F4,text="Maaza",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=0,column=0,padx=10,pady=10,sticky="w")
        ...
        F5.place(x=970,y=180,width=320,height=380)
        ...
        btn_F.place(x=670,width=580,height=100)
        
        total_btn=Button(btn_F,command=self.total,text="Total",bg="cadetblue",fg="black",bd=5,pady=15,width=10,font="arial 15 bold").grid(row=0,column=0,padx=2,pady=5)
        GBill_btn=Button(btn_F,text="Genrate Bill",command=self.bill_area,bg="cadetblue",fg="black",bd=5,pady=15,width=10,font="arial 15 bold").grid(row=0,column=1,padx=2,pady=5)
        Clear_btn=Button(btn_F,text="Clear",command=self.clear_data,bg="cadetblue",fg="black",bd=5,pady=15,width=10,font="arial 15 bold").grid(row=0,column=2,padx=2,pady=5)
        Exit_btn=Button(btn_F,text="Exit",command=self.Exit_app,bg="cadetblue",fg="black",bd=5,pady=15,width=10,font="arial 15 bold").grid(row=0,column=3,padx=2,pady=5)
        self.welcome_bill()
